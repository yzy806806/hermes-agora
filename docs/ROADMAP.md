...
## 状态：已纳入开发计划（由 planner 于 2026-06-11 确认）

## Phase 12: Multi-platform Agent Integration（已规划）
...
- 12.1a-f: Agent SDK（Python）— 包结构、AgoraAgentClient、AbstractBridge、run() 循环、SessionStore、测试+文档
- 12.2a-c: Hermes Bridge — HermesAdapter 设计、守护进程实现、真实 profile 测试
- 12.3a-e: CLI Bridge — PTY 管理器、Codex/Claude/OpenClaw 适配器、测试
- 12.4a-c: Node.js SDK — npm 包、Docker agent 示例、文档
- 12.5a-d: Agent 自我进化 — Session 存储模型、CRUD API、制品存储、SDK 集成
- 12.6a-b: Production Hardening — E2E WS 测试修复、版本断言修复
- 12.7a-d: 集成 + 文档 — ARCHITECTURE/API/ROADMAP/CHANGELOG 更新
